...
void InputPackage::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_pv_ownership_rate", "val"), &InputPackage::set_pv_ownership_rate);
	ClassDB::bind_method(D_METHOD("set_human_step_every_x_steps", "val"), &InputPackage::set_human_step_every_x_steps);
	ClassDB::bind_method(D_METHOD("set_pv_step_every_x_steps", "val"), &InputPackage::set_pv_step_every_x_steps);
