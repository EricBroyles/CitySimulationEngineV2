...
libname = "CITYSIMULATIONENGINEV2"
projectdir = "godot_project"
...
env.Append(CPPPATH=["src", "src/dev", "src/tests"])
...
sources = Glob("src/*.cpp") + Glob("src/dev/*.cpp") + Glob("src/tests/*.cpp") ## MINE
